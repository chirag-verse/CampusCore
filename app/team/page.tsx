...
const teamData = {
    ...
    'System Architect': [
        { name: 'Chirag Malik', role: 'System Architect Head', imageUrl: '/team/chirag.jpg',linkedinUrl: 'https://www.linkedin.com/in/bhavya-gupta-832366257?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app' },
    ],
    'Operations Manager': [
        { name: 'Gaurav Agarwal', role: 'Operations Manager', imageUrl: '/team/gaurav.jpg',linkedinUrl: 'https://www.linkedin.com/in/geetanshi-goel-49ba5832b/' },
    ],
    'Network Connector': [
        { name: 'Ayush Tomar', role: 'Network Connector', imageUrl: '/team/ayush.jpg',linkedinUrl: 'https://www.linkedin.com/in/yojit-tyagi-6a9429316' },
    ],
};
...
const TeamPage: NextPage = () => {
  useEffect(() => {
    document.title = 'Our Team | Campus Core Chapter';
  }, []);
            ...
            />    
                ...
                <div className="relative z-10">
                    <h1 className="text-5xl md:text-7xl font-black tracking-tighter text-white" style={{textShadow: '0 4px 20px rgba(59, 130, 246, 0.5)'}}>
                        The <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">Tech Avengers</span> of Campus Core
                    </h1>
                </div>
            </div>
