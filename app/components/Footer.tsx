        ...
        <footer className="bg-slate-900/50 border-t border-slate-800 py-16 px-4 text-slate-300">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
                <div className="flex flex-col items-center md:items-start">
                    ...
                    <h3 className="font-bold text-2xl text-white mb-4">Be the change you want to see!</h3>
                ...
                <div>
                    ...
                    <Link href="mailto:aayushimoral@gmail.com" className="block hover:text-blue-400 transition-colors">aayushimoral@gmail.com</Link>
                    <Link href="mailto:mlsa.community@miet.ac.in" className="block hover:text-blue-400 transition-colors">campuscore@gmail.com</Link>
                </div>
                <div>
            ...
            <div className="border-t border-slate-800 mt-12 pt-8 text-center text-slate-500">
                <p>&copy; {new Date().getFullYear()} Campus Core | DESIGNED BY Campus Core TEAM</p>
            </div>
        </footer>
    );
};
